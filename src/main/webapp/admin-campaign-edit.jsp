...
<head>
    <meta charset="UTF-8">
    <title>Edit Campaign - Admin - CarRent</title>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="segment" required>
                                    ...
                                    <option value="active_customers" ${campaign.segment == 'active_customers' ? 'selected' : ''}>Active Customers</option>
                                    <option value="new_customers" ${campaign.segment == 'new_customers' ? 'selected' : ''}>New Customers (30 days)</option>
                                </select>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="body" rows="8" required
                                          placeholder="Write your email content here. Include personalized greetings, offer details, and call-to-action.">${campaign.body}</textarea>
                            </div>

                            <div class="col-12">
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle me-2"></i>
                                    <strong>Campaign Status:</strong> ${campaign.status}
                                    <c:if test="${not empty campaign.sentDate}">
                                        <br><strong>Sent Date:</strong> ${campaign.sentDate}
                                        <br><strong>Emails Sent:</strong> ${campaign.sentCount}
                                    </c:if>
                                </div>
                            </div>
                        </div>
