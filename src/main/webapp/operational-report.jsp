...
<head>
    <meta charset="UTF-8">
    <title>Operational Reports - Car Rental System</title>
...
<body>
    ...
    <div class="sidebar">
        <div class="p-3">
            <div class="d-flex align-items-center mb-4">
                ...
                <h5 class="mb-0">Operations Manager</h5>
            </div>
            <nav class="nav flex-column">
                <a class="nav-link active" href="OperationalReportServlet"><i class="fas fa-chart-line"></i>Operational Reports</a>
                <a class="nav-link" href="fleet-status.jsp"><i class="fas fa-car"></i>Fleet Status</a>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <div class="d-flex align-items-center">
                ...
                <h4 class="mb-0">Operational Reports</h4>
            </div>
            <div class="d-flex align-items-center">
    ...
    <div class="main-content">
        <c:choose>
            <c:when test="${empty sessionScope.username || (sessionScope.role != 'admin' && sessionScope.position != 'Manager' && sessionScope.department != 'Operations')}">
                        ...
                        <div class="card">
                            <div class="card-body p-5">
                                <div class="text-center mb-4">
                                    ...
                                    <p class="text-muted">Please login as an Operations Manager to access operational reports.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <c:otherwise>
                ...
                <div class="section-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3><i class="fas fa-file-alt me-2"></i>Operational Reports - ${reportPeriod}</h3>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="get" action="OperationalReportServlet" class="row g-3">
                            <div class="col-md-3">
                ...
                <div class="row g-4 mb-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="card stat-card text-center p-4">
                            ...
                            <div class="display-6 fw-bold text-primary">${vehicleStats.totalVehicles}</div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card stat-card text-center p-4">
                            ...
                            <div class="display-6 fw-bold text-success">${vehicleStats.availableVehicles}</div>
                            <div class="text-muted">Available (${vehicleStats.availabilityRate}%) </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card stat-card text-center p-4">
                            ...
                            <div class="display-6 fw-bold text-warning">${maintenanceStats.underMaintenance}</div>
                            <div class="text-muted">Under Maintenance (${maintenanceStats.maintenanceRate}%)</div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card stat-card text-center p-4">
                            ...
                            <div class="display-6 fw-bold text-info">$${vehicleStats.totalFleetValue}</div>
                            <div class="text-muted">Fleet Value</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4 mb-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="card stat-card text-center p-4">
                            ...
                            <div class="display-6 fw-bold text-info">${performanceStats.totalBookings}</div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card stat-card text-center p-4">
                            ...
                            <div class="display-6 fw-bold text-primary">${performanceStats.utilizationRate}%</div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card stat-card text-center p-4">
                            ...
                            <div class="display-6 fw-bold text-success">$${incomeStats.totalIncome}</div>
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="fas fa-car me-2"></i>Vehicle Inventory Status</h5>
                        <div class="d-flex align-items-center">
                    ...
                    <div class="card-body">
                        <c:if test="${empty vehicleDetails}">
                                ...
                                <table class="table table-striped align-middle" id="vehiclesTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th><i class="fas fa-dollar-sign me-1"></i>Daily Rate</th>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="fas fa-calendar-alt me-2"></i>Recent Bookings (${reportPeriod})</h5>
                        <div class="d-flex align-items-center">
                            <i class="fas fa-search me-2 text-muted"></i>
                            <input type="text" id="bookingSearch" class="form-control form-control-sm" placeholder="Search bookings..." style="width: 250px;">
                        </div>
                    </div>
                    <div class="card-body">
                        <c:if test="${empty recentBookings}">
                            <div class="alert alert-info mb-0">
                                <i class="fas fa-info-circle me-2"></i>No bookings found for the selected period.
                            </div>
                        </c:if>
                                    ...
                                    <tbody>
                                        <c:forEach var="booking" items="${recentBookings}">
                                            <tr>
                                                ...
                                                <td>${booking.vehicleName} (${booking.vehicleType})</td>
    ...
    <script>
        function exportToExcel() {
            ...
            const tables = ['vehiclesTable', 'bookingsTable'];
            let csv = 'Operational Report - ${reportPeriod}\n\n';

            tables.forEach(tableId => {
                const table = document.getElementById(tableId);
                if (table) {
                    csv += tableId.replace('Table', '').toUpperCase() + '\n';
            ...
            link.download = 'operational_report_${reportMonth}_${reportYear}.csv';
            link.click();
        }
        ...
        // Search functionality for bookings table
